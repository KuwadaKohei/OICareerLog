...
<title>OICareerLog | 投稿編集</title>
<link rel="stylesheet" href="${contextPath}/css/style.css">
</head>

<body class="bg-gradient-primary">
	<c:url var="detailUrl" value="/ReportView">
		<c:param name="postId" value="${postForm.postId}" />
	</c:url>
	<!-- 固定ボタン -->
	<a href="${detailUrl}" class="btn btn-secondary fixed-back-button">
		<i class="bi bi-arrow-left"></i> 投稿詳細へ戻る
	</a>
	...
	<div class="container py-5">
		<div class="mx-auto" style="max-width: 960px;">
			<div class="mb-4 text-center">
				...
				<h1 class="h3 fw-bold">投稿情報を編集する</h1>
				<p class="text-muted mb-0">最新の体験談に更新し、後輩の就活に役立てましょう。</p>
			</div>
			...
			<form method="post" action="${contextPath}/ReportEdit" id="postForm">
				...
				<div class="card shadow-sm border-0 mb-4">
							...
							<div class="row g-3">
								...
								<div class="col-12">
									<label for="venueAddress" class="form-label">試験会場<span
										...
										placeholder="例：大阪市北区〇〇 〇〇ビル" required>
								</div>
							</div>
						</section>
					...
					<div class="card-footer bg-white border-0 px-4 px-md-5 pb-4">
						<div class="d-flex flex-column flex-md-row gap-3">
							<a href="${detailUrl}"
								class="btn btn-secondary flex-fill">投稿詳細へ戻る</a>
