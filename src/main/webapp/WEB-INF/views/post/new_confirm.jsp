...
<title>OICareerLog | 投稿内容の確認</title>
	...
	<div class="container py-5">
		<div class="mx-auto" style="max-width: 960px;">
			<div class="mb-4 text-center">
				...
				<h1 class="h3 fw-bold">入力内容の確認</h1>
				<p class="text-muted mb-0">投稿前に内容を再度確認してください。修正したい場合は「入力内容を修正する」を押してください。</p>
			</div>
					...
					<div class="card border-0 shadow-sm h-100">
						<div class="card-body">
							...
							<dl class="row mb-0">
								...
								<dd class="col-sm-8">
									<c:set var="method"
										value="${submissionMethodMap[postForm.methodId]}" />
									<c:choose>
			...
			<form method="post" action="${contextPath}/ReportNew"
				...
				<div class="card-body p-4">
					...
					<div class="d-flex flex-column flex-md-row gap-3">
						...
						<button type="submit" name="action" value="create"
							class="btn btn-primary flex-fill">この内容で投稿する</button>
					</div>
				</div>
			</form>
		</div>
